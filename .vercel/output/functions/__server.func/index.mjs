...
import { g as NodeResponse } from "./_libs/@tanstack/react-start+[...].mjs";
import { a as toEventHandler, i as defineLazyEventHandler, n as HTTPError, o as toMiddleware, r as callMiddleware, t as H3Core } from "./_libs/h3.mjs";
...
var _lazy_7SRYHz = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const $0 = {
		route: "/**",
		handler: multiHandler(toEventHandler(server_default), _lazy_7SRYHz)
	};
	return (m, p) => {
		if (p.charCodeAt(p.length - 1) === 47) p = p.slice(0, -1) || "/";
		let s = p.split("/");
...
//#endregion
export { vercel_web_default as default, renderErrorPage as t };
